...
export const CardContainer = ({
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    containerRef.current.style.transform = `perspective(1200px) rotateY(${x}deg) rotateX(${-y}deg) scale3d(1.02, 1.02, 1.02)`;
  };
  ...
  const handleMouseLeave = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    containerRef.current.style.transform = `perspective(1200px) rotateY(0deg) rotateX(0deg) scale3d(1, 1, 1)`;
  };
